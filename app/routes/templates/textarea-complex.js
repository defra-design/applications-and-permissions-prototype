...
module.exports = function (router)
{
    ...
    router.post(section + 'PAGENAME_TEXTAREA_COMPLEX-router', function (req, res)
    {
        ...
        if (req.session.data['SECTION-PAGENAME_TEXTAREA_COMPLEX-text-input'] == undefined || req.session.data['SECTION-PAGENAME_TEXTAREA_COMPLEX-text-input'] == "")
        {
            ...
            res.redirect('PAGENAME_TEXTAREA_COMPLEX');
        }

        else if (req.session.data['SECTION-PAGENAME_TEXTAREA_COMPLEX-text-input'].length > 15)
        {
        ...
        else if (req.session.data['SECTION-PAGENAME_TEXTAREA_COMPLEX-text-input'].length < 4)
        {
        ...
        else
        {
            ...
            let inputtext = req.session.data['SECTION-PAGENAME_TEXTAREA_COMPLEX-text-input'];
